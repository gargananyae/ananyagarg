...
function Intro(){
    return(
        ...
        <nav className='navbar'>
            <a href="/" className='logo'>AG</a>
            <ul>
                <li> <a href='https://drive.google.com/file/d/19uUPkwj1RGEvUDP41ZP1b9IYeoSWkNKQ/view?usp=sharing' className='resume' target='__blank'><strong>Resume</strong></a></li>
                <li> 
                    <a href='https://github.com/gargananyae' target='_blank'>
                ...
                <li> 
                    <a href='https://www.linkedin.com/in/ananya-garg01/' target='_blank'>
        ...
        <div className='body'>
            <div className="main-wrapper">
                ...
                <img src={require('../person.png')} className='personicon'></img>
                
            </div>
            <p className='subtitle'>Ananya Garg / Software Developer</p>
